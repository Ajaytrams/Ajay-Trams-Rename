...
async def doc(bot,update):
     ...
     await ms.edit("⚠️__**Please wait...**__\n__Ajay Trams Processing file upload....__")
     c_time = time.time() 
     try:
        if type == "document":
           await bot.send_document(
		    update.message.chat.id,
                    ...
                    progress_args=( "⚠️__**Please wait...**__\n__Ajay Trams Processing file upload....__",  ms, c_time   ))
        elif type == "video": 
